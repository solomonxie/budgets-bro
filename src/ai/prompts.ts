...
export type AnalysisKind = 'spending' | 'variance' | 'forecast' | 'health' | 'comparison';

export const ANALYSIS_KINDS: AnalysisKind[] = ['spending', 'variance', 'forecast', 'health', 'comparison'];
