...
export const zh: Record<keyof typeof en, string> = {
  ...
  'settings.testAiKey': '测试连接',
  'settings.aiKeyTestPassed': '连接成功——密钥可用。',
  'settings.aiKeyTestFailed': '无法用此密钥连接。',
  ...
  'babySteps.trackAccountsLabel': '关联账户',
  'babySteps.trackCategoriesLabel': '关联分类',
  'babySteps.selectAccounts': '选择账户',
  'babySteps.selectCategories': '选择分类',
  'babySteps.accountsSelected': '已选 {count} 项',
  ...
  'taxInsights.selectCategories': '选择分类',
  'taxInsights.categoriesSelected': '已选 {count} 项',
  ...
  'taxInsights.setUpDonationCategories': '在理财步骤中选择捐赠分类 →',
