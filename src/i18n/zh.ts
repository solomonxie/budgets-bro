...
export const zh: Record<keyof typeof en, string> = {
  ...
  'common.experimental': '实验功能 · 仍在开发中。这一页说的先当草稿看，后面还会补更多。',
  ...
  'babySteps.intro':
    '一套固定顺序的理财决策：把能挤出的钱全部投入当前这一步，完成后再进入下一步。顺序比速度更重要。这七个步骤出自 Dave Ramsey——页面顶部的链接是他本人的完整说明；这一页所做的，是从你的账户里读出进度，而不是靠你回忆。',
  ...
  'fx.sourceBody':
    '来自欧洲央行每日参考汇率，经由 frankfurter.app 获取——免费、无需账号、无需密钥。整张汇率表每天请求一次，你查看走势的每个货币对再各请求一次，且都在页面已经显示之后才发起；结果保存在本机，因此没有网络也能查看。请求里只有货币代码和日期范围：不含任何关于你或你财务的信息。参考汇率是中间价——银行或汇款服务给你的会更差一些，那个差额就是你付给他们的费用。',
  'currency.CAD': '加拿大元',
  'currency.USD': '美元',
  'currency.CNY': '人民币',
  'currency.EUR': '欧元',
