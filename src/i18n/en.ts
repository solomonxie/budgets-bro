...
export const en = {
  ...
  'babySteps.trackAccountsLabel': 'Track with account(s)',
  'babySteps.trackCategoriesLabel': 'Track with category(ies)',
  'babySteps.selectAccounts': 'Select account(s)',
  'babySteps.selectCategories': 'Select category(ies)',
  'babySteps.accountsSelected': '{count} selected',
  ...
  'taxInsights.selectCategories': 'Select category(ies)',
  'taxInsights.categoriesSelected': '{count} selected',
  ...
  'taxInsights.setUpDonationCategories': 'Pick giving categories in Baby Steps →',
