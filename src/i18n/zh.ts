...
export const zh: Record<keyof typeof en, string> = {
  ...
  'accounts.thisYearAmount': '今年：{amount}',
  ...
  'houseValueCard.updateButton': '+ 记一次房屋估值更新',

  'trackingValueCard.label': '余额趋势',
  'trackingValueCard.noValueYet': '尚未记录数值。',
  'trackingValueCard.logValueUpdate': '+ 记一次估值更新',
  'trackingValueCard.logBalanceUpdate': '+ 记一次余额更新',
