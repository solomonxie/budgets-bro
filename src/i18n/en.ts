...
export const en = {
  ...
  'babySteps.editHomePrice': 'Home price {price} (edit)',
  'babySteps.homeLabel': 'Where do you live?',
  ...
  'babySteps.paceEta': 'At {pace} a month, done by {date}',
  'babySteps.paceFar': 'At {pace} a month, more than 50 years away',
  'babySteps.paceStalled': 'No progress in the last 3 months',
