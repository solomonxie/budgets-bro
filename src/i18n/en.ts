...
export const en = {
  ...
  'settings.incomeHeading': 'Income',
  'settings.incomeHint': 'Every Income account automatically sweeps whatever you enter into this account, so the income account itself never carries a balance — it just records when and how much.',
  'settings.incomeCashAccountLabel': 'Default Cash Account',
  'settings.incomeCashAccountPlaceholder': 'Select…',
  ...
  'accountDetail.incomeThisMonth': 'Income This Month',
  'accountDetail.incomeThisYear': '{amount} this year',
