...
export const en = {
  ...
  'houseValueCard.updateButton': '+ Log an Update on Home Value',

  'trackingValueCard.label': 'Balance Trend',
  'trackingValueCard.noValueYet': 'No value recorded yet.',
  'trackingValueCard.logValueUpdate': '+ Log an Update on Value',
  'trackingValueCard.logBalanceUpdate': '+ Log an Update on Balance',
