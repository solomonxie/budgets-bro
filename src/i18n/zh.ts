...
export const zh: Record<keyof typeof en, string> = {
  ...
  'settings.incomeHeading': '收入',
  'settings.incomeHint': '每个收入账户都会自动将录入的金额转入此账户，因此收入账户本身不会累积余额——它只负责记录收入的时间和金额。',
  'settings.incomeCashAccountLabel': '默认现金账户',
  'settings.incomeCashAccountPlaceholder': '选择…',
  ...
  'accountDetail.incomeThisMonth': '本月收入',
  'accountDetail.incomeThisYear': '今年 {amount}',
